...
typedef enum
{
  ...
  INPUTINTERPRETER_CMD_CODECHIP_INSERTED,
  INPUTINTERPRETER_CMD_CASSETTE_INSERTED,
  INPUTINTERPRETER_CMD_SLEEP_REQUEST,
  INPUTINTERPRETER_CMD_POWER_BATTERY_LOW,
  INPUTINTERPRETER_CMD_POWER_BATTERY_CRITICAL,
  INPUTINTERPRETER_CMD_CHARGER_ATTACHED,
  INPUTINTERPRETER_CMD_CHARGER_DETACHED
